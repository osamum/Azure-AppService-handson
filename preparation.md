...
11. Web ブラウザーのナビゲーションバーの URL を以下のように変更します

    ```
    https://localhost:61260/api/swagger.json
    ```
    API の仕様を表す Open API(Swagger) の JSON ドキュメントが表示されます。

    ![Open API Documens](images/swagger_json.png)
...
| https://localhost:61260/api/swagger.json | Open API ドキュメント |
